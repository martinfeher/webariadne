          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-5 text-[16px] font-[600] text-gray-700  sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  {/* <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight"> */}
                  Live search,  gives visitors of the website an option to search for relevant information in blog posts, pages, products, categories and attributes.
