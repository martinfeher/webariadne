...
const NotificationPluginStatus = ({ clickCloseNotificationPluginStatus }) => {
  ...
  return (
    <>
        <div className="z-50 fixed inset-x-0 bottom-0 translate-y-0 scale-100 transform pb-2 opacity-100 transition duration-500 ease-out sm:pb-5">
          ...
          {/* <div className="rounded-[9px] bg-green-500 shadow-lg p-[4px] sm:p-[5px] border border-gray-300" > */}
            <div className="rounded-[9px] bg-blue-200 shadow-lg border border-gray-200" >
              ...
              {/* <div className="flex flex-wrap items-center justify-between" > */}
                <div className="text-slate-700 text-[13px] px-[4px] py-[10px] sm:py-[11px] ml-[18px]"><a href="/webariadne/plugin/webariadne_wordpress_plugin_v0.93.zip" className="text-sky-800 hover:text-sky-900 hover:underline" download>WebAriadne wordpress plugin</a> is available for you to be installed</div>
