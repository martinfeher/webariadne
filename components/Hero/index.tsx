          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="flex w-full px-4">
              <div
                ...
                data-wow-delay=".2s">
                <h1 className="mb-[8px] sm:mb-[10px] md:mb-4 !text-[17px] sm:!text-[18px] md:!text-[19px] text-gray-600">
                  WordPress search plugin to help visitors to find relevant information in a quick manner
                ...
                <div className="mb-[4px] text-[13px] text-gray-600 w-[80%] sm:w-[90%] md:w-auto text-center">
                  You can utilize customization properties to fit the search bar, results to your website content
