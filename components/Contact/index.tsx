            ...
            // <div className="wow fadeInUp mb-12 rounded-md bg-primary/[3%] py-4 px-8 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]"
              ...
              <form onSubmit={handleSubmit}>
                <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="w-full px-4">
                    <button className={`rounded-md ${messageSent ? 'bg-green-600' : 'bg-primary '} py-[7px] px-5 text-[13px] font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp`}
